...
imu_in = readtable("dat_sk0.csv");
gps_in = readtable("gps_sk0.csv");
data_range = 1:length(imu_in.('timestamp'));
data_range = data_range(811602:916575);
data_range = data_range(17352:25470);
data_range = data_range(1371:6787);
times = imu_in.('timestamp')(data_range);
t_data = (times - times(1)) / 1e6;
Az_in = imu_in.('acc_i_x')(data_range);
Ax_in = imu_in.('acc_i_y')(data_range);
Ay_in = imu_in.('acc_i_z')(data_range);
A = [Ax_in Ay_in Az_in] * 9.81;

Rz_in = imu_in.('rot_i_x')(data_range);
Rx_in = imu_in.('rot_i_y')(data_range);
Ry_in = imu_in.('rot_i_z')(data_range);
